...
const val CONTENT_AUTHORITY="com.rocko.tasktimer.provider"
private const val TASKS=100
private const val TASKS_ID=100
private const val TIMINGS=200
private const val TIMINGS_ID=201
private const val TASKS_DURATIONS=400
private const val TASKS_DURARIONS_ID=401
...
class AppProvider:ContentProvider(){
    ...
    private fun buildUriMatcher():UriMatcher{
        ...
        //content://rockos.app.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY,TasksContract.TABLE_NAME, TASKS)
        //content://rockos.app.tasktimer.provider/Tasks/8
...
//        matcher.addURI(CONTENT_AUTHORITY,"${DurationsContract.TABLE_NAME}/#", TASKS_DURARIONS_ID)
